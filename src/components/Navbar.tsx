        ...
        <NavbarBs sticky="top" className="bg-white shadow-sm mb-3">
          <Container>
            <Nav className="me-auto">
              <Nav.Link to="/ocado/" as={NavLink}>Sklep</Nav.Link>
              <Nav.Link  to="/ocado/cart" as={NavLink} style={{width:"100px"}}>Koszyk
              ...
              <Nav.Link to="/ocado/order-summary" as={NavLink}>Zamówienia</Nav.Link>
            </Nav>
